		...
		<div class="container  text-center">
			...
			<div class="agile_social_banner">
				<ul class="social_list">
					...
					<li><a href="#" class="social_dribble"><span class="fa fa-instagram" aria-hidden="true"></span></a></li>
					<li><a href="#" class="social_vimeo"><span class="fa fa-linkedin" aria-hidden="true"></span></a></li>
				</ul>
			</div>
		</div>
		<div class="footer">
